      ...
      <div className="flex-1 ml-64">
        ...
        <header className="sticky top-0 z-10 bg-surface/80 backdrop-blur-xl px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center text-on-primary text-xs font-bold">
              ?
            </button>
            <div className="flex items-center gap-3 ml-2">
              <div className="text-right">
                <p className="text-sm font-medium text-on-surface">Demo User</p>
